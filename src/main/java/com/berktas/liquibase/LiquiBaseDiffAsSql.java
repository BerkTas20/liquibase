...
public class LiquiBaseDiffAsSql {
    ...
    public static void diff()
        ...
        Connection referenceConnection =
                DriverManager.getConnection("jdbc:mariadb://localhost:3306/product", "root", "12345");

        Connection targetConnection =
                DriverManager.getConnection("jdbc:mariadb://localhost:3306/empty_product", "root", "12345");
